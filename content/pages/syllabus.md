...
correspondence (reach out to me!: [ashley.naimi@emory.edu](mailto:ashley.naimi@emory.edu)).
...
Labs meet Monday mornings and practice the *preceding* week's lecture — each lab follows the lecture that teaches its content. (Lab 1 runs Mon 9/14, after the Week-2 lecture; Lab 2 runs Mon 9/21, after the Week-3 lecture; and so on.)
